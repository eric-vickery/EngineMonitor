...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .overlay(
            VStack {
                if engineData.healthStatus != .dead
                {
                    HStack {
                    ...
                    VStack(alignment: .leading) {
                        ...
                        StraightGauge(label: "VOLTS", dataKey: "volts", minValue: 12.0, maxValue: 16.0, ranges: [Range(startingPercent: 0.01, endingPercent: 0.2, color: .red), Range(startingPercent: 0.2, endingPercent: 0.72, color: .green), Range(startingPercent: 0.72, endingPercent: 0.85, color: .yellow), Range(startingPercent: 0.85, endingPercent: 0.99, color: .red)])
                    }
